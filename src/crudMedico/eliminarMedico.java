...
public class eliminarMedico extends JPanel{
	...
	private void inicializar() {
		lblTitulo=new JLabel("    Eliminar Médico");
	...
	private void caracteristicas() {
		...
		btnBuscar.setActionCommand(Acciones.BUSCAR_MEDICO_ELIMINAR);
		
		btnEliminar.setBackground(Color.BLACK);
		btnEliminar.setFont(new Font("Algerian", 0, 25));
		btnEliminar.setForeground(Color.white);
		btnEliminar.setBounds(70,350, 200, 50);
		btnEliminar.setActionCommand(Acciones.BTN_ELIMINAR_MEDICO);
