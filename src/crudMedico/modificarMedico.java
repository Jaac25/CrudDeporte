...
public class modificarMedico extends JPanel{
	...
	private void inicializar() {
		lblTitulo=new JLabel("Modificar Médico");
	...
	private void caracteristicas() {
		...
		lblTitulo.setBounds(140, 0, 350,50);
		...
		jCbcargo.addItem(String.valueOf(cargoMedico.GENERAL));
		jCbcargo.addItem(String.valueOf(cargoMedico.TERAPEUTA));
		
		btnBuscar.setBackground(Color.BLACK);
		btnBuscar.setFont(new Font("Algerian", 0, 13));
		btnBuscar.setForeground(Color.white);
		btnBuscar.setBounds(500,60,85,35);
		btnBuscar.setActionCommand(Acciones.BUSCAR_MEDICO_MODIFICAR);
		
		btnModificar.setBackground(Color.BLACK);
		btnModificar.setFont(new Font("Algerian", 0, 25));
		btnModificar.setForeground(Color.white);
		btnModificar.setBounds(70,350, 200, 50);
		btnModificar.setActionCommand(Acciones.BTN_MODIFICAR_MEDICO);
